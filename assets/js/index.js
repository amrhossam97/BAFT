    ...
    <img src="/assets/img/whoAreWeAR.png" class="img-fluid who-we-are ">
        ...
        <div class="col-12 col-sm-8  m-auto my-5 position-relative ">
            ...
            <div id="rounded-bottom" class="w-75 rounded-bottom ">
                <p class="rounded-body  ">
                    تعتبر شركة بيان الرمال للأغذية والمشروبات فرع من كيان اكبر في تخصصات مختلفة
                    مثل الاعلام والسياحة والمقاولات 
                </p>
            </div>
        </div>
        <div class="col-8  mx-auto justify-content-center align-items-center">
        <p class="parg-header d-block text-center w-100">رؤيتنا</p>
        <p class="parg-body d-block text-center">مواكبة رؤية المملكة٢٠٣٠ والوصول لاعلي مستوي من الجودة في مجال 
            توريد الأغذية والمشروبات </p>

        <p class="parg-header d-block text-center w-100">رسالتنا </p>
        <p class="parg-body d-block text-center">امداد المنشات المتخصصة بتقديم الأغذية والمشروبات بمنتجات عالية الجودة طبقا لانظمة ومعايير 
            الجودة والسلامة المطبقة عالميا </p>
...
رسالتها بأعلي معايير الجودة المطلوبة تجاه منسوبيها وعملائها لتقديم غذاء 
امن للمجتمع
                </p>
            </div>
        </div>
        <div class="col-6  ">
            ...
            <div class="card-body w-75 m-auto">
                <p>تمكن بيان الرمال موظفيها من خلال التدريب
                    ...
                    التي يحتاجون اليها لاتخاذ وتنفيذ القرارات الصائبة 
        ...
        <div class="col-6  ">
            ...
            <div class="card-body w-75 m-auto">
                <p>ملتزمون بأداء اعمالنا بأمانة وعدل ووفق اعلي 
        ...
        <div class="col-6 ">
            ...
            <div class="card-body w-75 m-auto">
                <p>تعمل بيان الرمال علي تعزيز روح التعاون داخل 
                    المنشأة ومع شركائها وأي جهة ذات علاقة مباشرة 
